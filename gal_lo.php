...
<body>
        ...
        <div id="wrapper">
       <h2>This page is the Lo-poly gallery</h2>
   <header> 
   	<div id = "header-inner" >
   	  <div id="header-left">
   	  	 <div id="logo">
...
<li><a class="fancybox" href="contact.php" data-fancybox-width="400" data-fancybox-height="500" title="nothing is off limits"><img id="contact4" src="images/contact.png" alt="sdf" /></a></li>
	...
	<div id="main" role="main">
      <section class="slider">
        <div class="flexslider">
          <ul class="slides">
            <li data-thumb="images/lo_1.jpg" >
  	    	    <img src="images/lo_1.jpg" alt="news" />
  	    		</li>
  	    		<li data-thumb="images/lo_2.jpg" >
  	    	    <img src="images/lo_2.jpg" alt="news" />
  	    		</li>
  	    		<li data-thumb="images/lo_3.jpg" >
  	    	    <img src="images/lo_3.jpg" alt="news" />
  	    		</li>
  	    		<li data-thumb="images/lo_4.jpg">
  	    	    <img src="images/lo_4.jpg"  alt="news"/>
  	    		</li>
  	    		 </ul>
    ...
    <h2>This pageis the lo poly/mobile page</h2>
